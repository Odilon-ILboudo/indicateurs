// Ported from platon/libs/feature/resource/browser/src/lib/components/event-item
...
import { AuthService, UserAvatarComponent } from '../../core-browser'
import {
  ResourceCreateEvent,
  ResourceEvent,
  ResourceEventData,
...
type ComponentType<T> = new (...args: never[]) => T
