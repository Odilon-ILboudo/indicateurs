...
// Ported from platon/libs/feature/resource/browser/src/lib/components/resource-files
...
import { ClipboardService, PickerBrowserService } from '../../nge-services'
import { NgeUiIconModule } from '../../nge-ui-icon'
import { DialogModule, DialogService, UserAvatarComponent } from '../../core-browser'
import { GitLogResult, ResourceFile } from '../../resource-common'
...
import { ResourceFileService } from '../services'
